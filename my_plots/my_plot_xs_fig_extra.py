...
data1 = np.loadtxt("my_xs_rs_ee_txt/xs_SM_txt/xs_ee_vlvlh.txt")#, skiprows=1)
...
data2 = np.loadtxt("my_xs_rs_ee_txt/xs_SM_txt/xs_ee_zh.txt")#, skiprows=1)
...
# Plot the data
plt.plot(x2, y2, linestyle='-', color='b', label='zh')#marker='o' 
plt.plot(x1, y1, linestyle='-', color='r', label=r'$\nu\nu$h')#marker='o'
plt.plot(x2p, y2p, linestyle='--', color='b', label='zh (pol. 30%/-80%)')#marker='o' 
...
# Labels and title
plt.title(r'Cross Section $\sigma$ vs $\sqrt{s}$')
